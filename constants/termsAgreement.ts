export const TERMS_AGREEMENT_LIST = {
  // 서비스 이용약관
  SERVICE: `**제1조 (목적)**
...
1. 이 약관은 [시행일자]부터 시행됩니다.`,
  ...
  // 개인정보 처리 방침
  PRIVACY: `HANG-ON(이하 "회사" 또는 "행온")은 이용자의 개인정보를 중요시하며, 「개인정보 보호법」을 준수하고 있습니다. 본 개인정보 처리방침은 이용자가 제공한 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보 보호를 위해 어떠한 조치가 취해지고 있는지를 알려드립니다.
